...
begin
  CreateUnitDAOInterfaces(FPath, FNamespace, Project);
end;
...
begin
  ...
  CreateUnitDAOInterfaces(FPath, FNamespace, GetActiveProject);
  ...
  TFSDNewProjectMainFormCreator.New(FPath, FNamespace);
  TFSDNewProjectCadastroFormCreator.New(FPath, FNamespace);
end;
