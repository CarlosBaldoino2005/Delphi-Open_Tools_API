...
constructor TFSDNewProjectMainFormCreator.create(Path, Namespace: String);
var
  module: IOTAModule;
  unitPath: String;
  unitFileName: String;
...
class function TFSDNewProjectMainFormCreator.New(Path, Namespace: string): IOTACreator;
begin
