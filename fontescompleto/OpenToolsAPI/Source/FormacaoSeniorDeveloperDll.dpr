...
uses
  System.SysUtils,
  System.Classes,
  FSD.BasicMenu.Wizard in 'BasicMenu\FSD.BasicMenu.Wizard.pas',
  FSD.MainMenu.Wizard in 'MainMenu\FSD.MainMenu.Wizard.pas',
  FSD.Modelo.Classes in 'Modelo\FSD.Modelo.Classes.pas',
  FSD.Modelo.DAO.Creator in 'Modelo\FSD.Modelo.DAO.Creator.pas',
  FSD.Modelo.DAO.SourceFile in 'Modelo\FSD.Modelo.DAO.SourceFile.pas',
  FSD.Modelo.Entity.Creator in 'Modelo\FSD.Modelo.Entity.Creator.pas',
  FSD.Modelo.Entity.SourceFile in 'Modelo\FSD.Modelo.Entity.SourceFile.pas',
  FSD.Modelo.FormCadastro.Creator in 'Modelo\FSD.Modelo.FormCadastro.Creator.pas',
  FSD.Modelo.FormCadastro.SourceFile in 'Modelo\FSD.Modelo.FormCadastro.SourceFile.pas',
  FSD.Modelo.Forms in 'Modelo\FSD.Modelo.Forms.pas' {FSDGeradorModeloForms},
  ...
  FSD.NewProject.NewForm.Cadastro in 'NewProject\FSD.NewProject.NewForm.Cadastro.pas',
  FSD.NewProject.NewForm.Cadastro.SourceFile in 'NewProject\FSD.NewProject.NewForm.Cadastro.SourceFile.pas',
  FSD.NewProject.NewForm.Main in 'NewProject\FSD.NewProject.NewForm.Main.pas',
  FSD.NewProject.NewForm.Main.SourceFile in 'NewProject\FSD.NewProject.NewForm.Main.SourceFile.pas',
  ...
  FSD.Utils in 'FSD.Utils.pas',
  FSD.DLL.Register in 'FSD.DLL.Register.pas',
  ToolsAPI,
